...
img_color = cv2.imread('./1234.PNG',cv2.IMREAD_COLOR) # 이미지 불러오기 (경로만 바꾸어주면 됨)
...
contours.sort(key=lambda x:get_contour_precedence(x, img_binary.shape[1]))
